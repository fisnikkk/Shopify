// src/components/work/StudyStickyOutcomes.tsx
"use client";
...
type StudySticky = {
  ...
  meta?: { client?: string; role?: string; year?: string | number };
};

export default function StudyStickyOutcomes({ cs }: { cs: StudySticky }) {
